...
const LabelEstimateTripTime = 'Estimate trip time and price';
...
const  String labelNameError='Please enter a valid Name';
const String labelEmailError="Please enter a valid Email";
const String labelPhoneNoError="Mobile number must be of length 11";
const String labelPasswordError="Password mut contain one of r'^(?=.*[A-Za-z])(?=.*\d)\S{8,}]\$ ";
const String labelSignInError="Cannot sign in with those credentials";
 const String LabelCardIsAdded = "Card Is Added";
 const String LabelLenghtMustBeSixteen = "Numeric Lenght of Card Number Must Be 16";
 const String LabelTryAgain = "Please Try Again";
 const String LabelInvalidName = "Name Lenght Must Be Greater Then 4";